...
public class WXPayConstants {
     ...
     * 公众号、小程序appid
     */
    public static String APP_ID ="wxcf1014d13278b3c9"; // 真实
    public static String APP_ID_XXX = "xxx"; // 测试/第二个账号

    /**
     * AppSecret
     */
    public static String SECRET = "jiapuwang20151"; // 真实
    public static String SECRET_XXX = "xxx"; // 测试/第二个账号

    /**
     * 商户号
     */
    public static final String MCH_ID = "1283041301"; // 真实
     ...
     * API密钥，在商户平台设置
     */
    public static final String API_KEY = "jiapuwang201511230smilespeed8888"; // 真实
